...
def decompose_symbolic_obs(obs, map_obs_shape):
    flat_map_obs_shape = map_obs_shape[0] * map_obs_shape[1] * map_obs_shape[2]
    image_obs = obs[:, :flat_map_obs_shape]
    image_obs = image_obs.reshape((image_obs.shape[0], *map_obs_shape))
...
class ActorCriticConvSymbolicCraftax(nn.Module):
    ...
    def __call__(self, obs):
        ...
        image_obs, flat_obs = decompose_symbolic_obs(obs, self.map_obs_shape)
