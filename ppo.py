...
def make_train(config):
    ...
    def train(rng):
        ...
        if "Symbolic" in config["ENV_NAME"]:
            if config["NETWORK_TYPE"] == "symbolic_flat":
            ...
            elif config["NETWORK_TYPE"] == "symbolic_conv":
                ...
                network = ActorCriticConvSymbolicCraftax(
                    ...
                    pool_size=config["NETWORK_POOL_SIZE"],
                    pool_stride=config["NETWORK_POOL_STRIDE"],
                ...
                raise ValueError(
                    f"Unknown symbolic network type: {config['NETWORK_TYPE']}"
                )
        else:
...
if __name__ == "__main__":
    ...
    # Network
    parser.add_argument("--network_type", type=str, default="symbolic_conv")
    parser.add_argument("--layer_size", type=int, default=1024)
    parser.add_argument("--network_conv_layers", type=int, default=1)
    parser.add_argument("--network_conv_features", type=int, default=8)
    parser.add_argument("--network_conv_kernel_size", type=int, default=3)
    parser.add_argument("--network_pool_size", type=int, default=1)
    parser.add_argument("--network_pool_stride", type=int, default=1)
    parser.add_argument("--network_num_embedding_layers", type=int, default=2)
    parser.add_argument("--network_num_actor_layers", type=int, default=3)
    parser.add_argument("--network_num_critic_layers", type=int, default=3)
